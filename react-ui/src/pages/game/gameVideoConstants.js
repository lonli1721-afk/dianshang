...
export const FALLBACK_VIDEO_MODELS = [
  {
    ...
    limit_note: '生成时长 4-15 秒；支持 720P/1080P；高级视频编辑参考视频需 15.2 秒以内。',
  ...
  },
  {
    ...
    default_resolution: '720p',
    limit_note: '生成时长 4-10 秒；Fast 仅开放 720P；高级视频编辑参考视频需 15.2 秒以内。',
  ...
  },
  {
    ...
    supported_resolutions: ['720p'],
    default_resolution: '720p',
    limit_note: '生成时长 4-12 秒；支持 1 张首帧图或 2 张首尾帧图；不支持参考视频。',
  ...
  },
  {
    ...
    supported_resolutions: ['720p', '1080p'],
    default_resolution: '720p',
    limit_note: '生成时长 3-15 秒；不需要参考图或参考视频。',
    supported_modes: ['generate'],
    price_per_second: 0.9,
    price_unit: 'CNY',
    price_per_second_1080p: 1.6,
    price_note: '官方价格：720P 0.9 元/秒，1080P 1.6 元/秒。',
  },
  {
    ...
    supported_resolutions: ['720p', '1080p'],
    default_resolution: '720p',
    limit_note: '生成时长 3-15 秒；必须且只能使用 1 张首帧参考图。',
    supported_modes: ['generate'],
    price_per_second: 0.9,
    price_unit: 'CNY',
    price_per_second_1080p: 1.6,
  ...
  },
  {
    ...
    supported_resolutions: ['720p', '1080p'],
    default_resolution: '720p',
    limit_note: '生成时长 3-15 秒；支持 1-9 张角色/场景参考图。',
    supported_modes: ['generate'],
    price_per_second: 0.9,
    price_unit: 'CNY',
    price_per_second_1080p: 1.6,
  ...
  },
  {
    ...
    supported_resolutions: ['720p', '1080p'],
    default_resolution: '720p',
    limit_note: '输出视频最长 15 秒；输入参考视频需 3-60 秒；最多 1 个参考视频，可附加 0-5 张参考图。',
    supported_modes: ['reference_video', 'advanced_video'],
    price_per_second: 0.9,
    price_unit: 'CNY',
    price_per_second_1080p: 1.6,
    price_billing: 'input_output',
    price_note: '官方价格：720P 0.9 元/秒，1080P 1.6 元/秒；视频编辑按输入视频与输出视频分别计费。',
  },
  {
    id: 'veo3.1-fast',
    name: 'Veo 3.1 Fast',
    ...
    supported_resolutions: ['720p'],
    default_resolution: '720p',
    limit_note: 'ToAPIs Veo 3.1 固定生成 8 秒，支持 16:9 / 9:16，可选参考图。',
    supported_modes: ['generate'],
    price_unit: 'ToAPIs',
  },
  {
